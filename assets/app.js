(function(){
  ...
  const CAT_ICONS=[['hamburg','🍔'],['burger','🍔'],['pizza','🍕'],['pollo','🍗'],['alit','🍗'],['wing','🍗'],
    ...
    ['torta','🎂'],['fruta','🍓'],['vega','🥗'],['bowl','🥣'],['arroz','🍚'],['maki','🍣'],['nigiri','🍱'],
    ['sashimi','🐟'],['entrada','🥢'],['sake','🍶'],['matcha','🍵'],['ramen','🍜'],['tempura','🍤']];
  ...
  function renderCatalog(){
    ...
    if(activeFilter==='__favs__'){
      setActiveChip(null);
      renderFlat(products.filter(p=>isFav(p.id)&&matchSearch(p)),'Tus Favoritos','❤️','No tienes favoritos aún.');
      return;
    }
